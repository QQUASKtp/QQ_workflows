...
parser.add_argument("-o", "--outCloud", type=str, required=True, 
                    help="Output ply file ")
args = parser.parse_args() 

#incloud = '/home/ciaran/MalvernCompare/StatueCleanCrop.ply'
#outcloud = '/home/ciaran/MalvernCompare/StatueRefined.ply'
...
print(points.size(), "point(s) remaining,", points.garbage_size(), "point(s) removed")
